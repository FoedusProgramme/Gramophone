...
object Contributors {
    ...
    for user in GITHUB_USERS:
        ...
        bio = ("\"" + urllib.parse.quote(user_data["bio"]) + "\"") if ("bio" in user_data and user_data["bio"]) else "null"
        ...
        result += f"\n        GitHubUser(login=\"{login}\", name=decode({name}), avatar=R.drawable.{filename}, contributed=R.string.{user[1]}, bio=decode({bio})),"
